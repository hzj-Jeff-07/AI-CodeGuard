...
| M6 More languages | Done | Go: 8 rules; Java: 9 rules (`CG-001`/`CG-002`/`CG-020`/`CG-021`/`CG-030`/`CG-040`/`CG-041`(Java only)/`CG-050`/`CG-060`) |
...
| Auth / Crypto | `CG-020`, `CG-021` | Hardcoded credentials (also Go and Java), weak cryptography (also Go and Java) |
