...
| M6 More languages | Done | Go: 10 rules; Java: 12 rules (adds `CG-010`, `CG-031`, `CG-041` over the Go set); PHP: 12 rules (adds `CG-021`/`CG-031`/`CG-040`/`CG-041`/`CG-050` over the original MVP set) |
...
- Go covers 10 rules (`CG-001`/`CG-002`/`CG-020`/`CG-021`/`CG-022`/`CG-030`/`CG-031`/`CG-040`/`CG-050`/`CG-060`); Java covers those plus `CG-010`/`CG-041` (12 total); PHP covers those plus `CG-003`/`CG-041` (12 total). `CG-011` (DOM-based XSS) is JS/TS-only since it needs a browser DOM
